...
#-----------splash_screen------------------------------------------------------------------------------------------------------------------
sroot = Tk()
sroot.minsize(height=500,width=1080)
sroot.configure(bg='white')
spath = "images/picture.jpg"
...
Label(sroot,text="Chaitanya patil",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="Chetup988@gmail.commahant001@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Chaitanya',fg='black',bg='gray91',font='msserif 8')
